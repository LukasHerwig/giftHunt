    ...
    <div className="min-h-screen bg-ios-background pb-32">
      ...
      <div className="relative h-[45vh] min-h-[350px] w-full overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-16 px-4 flex justify-center">
          <div className="w-full max-w-4xl bg-white/10 backdrop-blur-2xl border border-white/20 rounded-[32px] px-8 py-8 flex flex-col items-center justify-center shadow-2xl">
            <h1 className="text-[32px] font-bold text-white tracking-tight leading-tight text-center">
              {wishlist.title}
            </h1>
