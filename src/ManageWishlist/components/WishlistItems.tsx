    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
      {items.map((item) => (
        <button
            ...
            {item.url ? (
              <img
                ...
                onError={(e) => {
                  ...
                  if (parent) {
                    const fallback = parent.querySelector('.gift-fallback');
          ...
          {/* Title Overlay */}
          <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-white/95 via-white/50 to-transparent dark:from-zinc-900/90 dark:via-zinc-900/50 dark:to-transparent">
